            ...
            Append(
                ...
                (System.Action) (() => {
                        ...
                        if (steamVRUpdateType != null) {
                            FieldInfo currentVersionField =
                                steamVRUpdateType.GetField("currentVersion",
                        ...
                        if (ovrPluginType != null) {
                            Append(
                                ...
                                (System.Action)(() => {
                                        FieldInfo wrapperVersionField =
                                            ovrPluginType.GetField("wrapperVersion",
                                        ...
                                        PropertyInfo versionField =
                                            ovrPluginType.GetProperty(
                                                "version", BindingFlags.Public | BindingFlags.Static);
                                        if (versionField != null) {
                                            Version version = (Version) versionField.GetGetMethod().Invoke(null, null);
                                            Append("version", version);
                                        }

                                        PropertyInfo nativeSDKVersionField =
                                            ovrPluginType.GetProperty("nativeSDKVersion",
                                                                      BindingFlags.Public | BindingFlags.Static);
                            ...
                            string symbols = string.Join(
                                ...
                                PlayerSettings.GetScriptingDefineSymbolsForGroup(targetGroup)
                                              ...
                                              .Where(symbol => !symbol.StartsWith(
                                                         VRTK_Defines.VersionScriptingDefineSymbolPrefix,
